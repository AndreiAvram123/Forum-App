...
public class FragmentRecipesList extends Fragment {
    ...
    public static FragmentRecipesList getInstance(@NonNull ArrayList<Recipe> recipes){
        FragmentRecipesList randomRacipesFragment = new FragmentRecipesList();
        Bundle bundle = new Bundle();
        bundle.putParcelableArrayList(KEY_POPULAR_RECIPES, recipes);
    ...
    private void  initializeRecyclerViewAdapter(){
        recyclerView.setAdapter(new AdapterRecyclerView(popularRecipes,getActivity()));
